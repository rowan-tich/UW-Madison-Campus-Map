...
public class BaseGraph <NodeType, EdgeType extends Number> {
    ...
    protected class Edge {
        ...
        public boolean busPath;
        public Edge(EdgeType data, Node pred, Node succ, boolean busP) {
            this.data = data;
        ...
        public String toString() {
            return data + "data " + predecessor + "pred " + successor + "succ";
        }
    }
    ...
    public boolean insertEdge(NodeType pred, NodeType succ, EdgeType weight, boolean busPath) {
        ...
        try {
            ...
            Edge newEdge = new Edge(weight,predNode,succNode, busPath);
            this.edgeCount++;
